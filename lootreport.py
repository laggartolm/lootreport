...
class Coords:
    data_box = ((530, 300), (1150, 400))
    green_check_pixel = (462, 11)
    gift_check_pixel = (10, 10)
    block_check_pixelrange = list([(405, y) for y in range(10, 96, 10)] + # right-side column to see if there's screen messages
                                   ...
                                   [(69, 84), (69, 53)] # waiting symbol
                                   )
    monster_box = (5, 5, 400, 32)
    hunter_box = (70, 38, 400, 62)
    loot_box = (70, 70, 400, 95)
    keys_box = (545, 70, 615, 95)
    open_delete_button_pos = (1100, 330)
    rest_pos = (100, 100)
